...
We decided to split the Kaggle training data into sub sets train and validation ()data 
...
As mentioned in feature selection section we proceeded with subsets that we got out from forward and backward feature selection with following variables:
...
We decided to try SVR with the data set we got out from feature selection
