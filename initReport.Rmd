...
Later during the project we also plotted the distributions of the test data, and found that the distribution of "NumOfConf" is totally different from the training data. We ended up removing this variable from most of the models. 
...
To out perform our dummy model we choose to fit a linear model for reference with all variables included. Our score with this model was 0.708. 
...
Our score in kaggle was 0.7098 with this model. 
...
So after trying with linear models, Random forest, PCR and SVR, SVR ended up being the best in this competition.
